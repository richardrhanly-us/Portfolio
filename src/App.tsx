    ...
    <main>
        ...
        <div className="project-grid">
          ...
          <article className="project-card">
            ...
            <div className="project-content">
              ...
              <div className="project-links">
                <a href="#aircraft-simulator-case-study">View Details</a>
      ...
      >
        ...
        <div className="case-study-intro">
          <div className="case-study-copy">
            <h3>
              Simulating aircraft telemetry, commands, and communication faults
            </h3>

            <p>
              Aircraft Mission Systems Simulator is a C++17 distributed-systems
              project that models communication between aircraft software and a
              mission-control system using separate processes and UDP
              networking.
            </p>
          ...
          <figure className="case-study-image-container">
            ...
            <figcaption>
              The simulator transmits aircraft telemetry, detects communication
              faults, and processes mission-control commands over UDP.
            </figcaption>
          </figure>
        </div>
        ...
        <div className="case-study-details">
          ...
          <article>
            ...
            <p>
              ...
              telemetry monitoring, command generation, and command processing,
              connected through UDP sockets and JSON message schemas.
            </p>
          </article>
