      ...
      <section id="sortview-case-study" className="section case-study">
        ...
        <div className="case-study-intro">
          <div className="case-study-copy">
            ...
            <p>
              The centerpiece of the SortView project is the Automated Materials
              Handler (AMH). As library patrons return their items, the AMH
              scans the items, communicates with the library ILS system, and
              routes each item into the appropriate bin.
            </p>
        ...
        <div className="case-study-details">
          <article>
            <h3>The Problem</h3>
            <p>
              The sorter generated valuable operational information, but the raw
              logs were difficult to review, compare, and use for
        ...
        <section className="project-walkthrough">
          <div className="project-walkthrough-header">
            ...
            <h3>SortView Dashboard</h3>

            <p>
              A walkthrough of how sorter activity becomes operational
              reporting, historical metrics, filtering, and system-level
              analysis.
            </p>
          </div>
