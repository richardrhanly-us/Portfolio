    ...
    <main>
      <section id="projects" className="section">
        ...
        <p className="projects-intro">
          Selected work across application development, data and analytics,
        ...
        <section className="project-category">
          <p className="section-label">Applications & Product Development</p>

          <h3>Software built around real workflows and decision-making</h3>
        ...
        <section className="project-category">
          <p className="section-label">Data, AI & Analytics</p>

          <h3>Turning data into useful analysis and interactive tools</h3>
        ...
        <section className="project-category">
          <p className="section-label">Cloud, Systems & Reliability</p>

          <h3>
            Infrastructure, systems engineering, and operational reliability
          </h3>
            ...
            <article className="project-card">
              ...
              <div className="project-content">
                ...
                <p>
                  ...
                  deployment, centralized monitoring, controlled failure
                  testing, and service recovery.
                </p>
